...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-gsjoyrc.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-gsjoyrc.containers.anotherwebservice.com/
...
```
git clone git@github.com:avycado13/container-gsjoyrc.git
cd container-gsjoyrc
```
...
```
docker attach container-gsjoyrc
```
